...
public class Solution {
    public static void main(String[] args) {
        ...
        editUserView.fireEventUserDeleted(model.getModelData().getActiveUser().getId());
        editUserView.fireEventUserChanged("Kostian", model.getModelData().getActiveUser().getId(), 5);
    }
}
