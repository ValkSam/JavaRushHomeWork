...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        mapper.writeValue(outStr, one);
        StringReader inStr = new StringReader(outStr.toString().replaceFirst("\"" + one.getClass().getSimpleName().toLowerCase() + "\"",
                "\"" + resultClassObject.getSimpleName().toLowerCase() + "\""));
        return mapper.readValue(inStr, resultClassObject);
    }
