...
public class Arcanoid
{
    ...
    public void checkBricksBump()
    {
        for (int i = 0; i<this.bricks.size();i++) {
            if (this.ball.isIntersec(this.bricks.get(i))) {
    ...
    {
        if (this.ball.isIntersec(this.stand)){
            this.ball.setDirection(80 + Math.random()*20);
        }
    }
    ...
    {
        if (this.ball.getY() > this.height) isGameOver = true;
    }
