...
public class Solution {
    ...
    public static class Duck implements Flyable, Movable {
        @Override
        public void doAction(Flyable object) {
            System.out.println("flying");
        }
        public void doAction(Movable object) {
    ...
    public static class Util {
        static void fly(Flyable animal) {
            animal.doAction((Flyable)animal);
        }

        static void move(Movable animal) {
            animal.doAction((Movable)animal);
        }
    }

    public static interface Flyable {
        void doAction(Flyable object);
    }

    public static interface Movable {
        void doAction(Movable object);
    }
}
